          ...
          >
            ...
            <div className="mt-6 border-t border-[#0E3B36]/15 pt-4">
              ...
              <a
                ...
                rel="noreferrer"
                onClick={closeAssistant}
                className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#25D366] px-6 py-3.5 text-[15px] font-medium text-white transition-colors hover:bg-[#1fba59]"
              >
